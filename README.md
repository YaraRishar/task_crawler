...
<br>
Использовать прокси. Все прокси хранятся в файле `proxy_list.txt`. Подключение осуществляется с помощью ProxyDownloaderMiddleware. Можно задать свои или использовать `scrapy crawl proxy_refresher` для подхвата бесплатных https-прокси с https://free-proxy-list.net/en/. \
